...
/*
 Descricao: movimento para subir um degrau a direita
*/
 void stepUpRight( )
 {
    turnLeft( );
 ...
 /*
 Descricao: movimento para subir um degrau a esquerda
*/
 void stepUpLeft( )
 {
    turnRight( );
...
*/
 ...
 /*
 Descricao: movimento para deixar os beepers em certa localização
*/
 void putBeepers(  )
 {
   if (beepersInBag( ))
